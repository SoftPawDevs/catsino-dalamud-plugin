...
Public, untrusted dealer client for Catsino. It provides dealer authorization, session management, exact-player invites, confirmed manual deposit reporting, and execution of backend-issued outgoing payout legs through a narrowly versioned Dropbox IPC.
...
- `src/Catsino.Plugin.Contracts`: portable public backend contract v1.0.0.
...
Open the single plugin window in game with `/catsino`.
